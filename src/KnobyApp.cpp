...
#pragma region Static Funktions
    VKAPI_ATTR VkBool32 VKAPI_CALL KnobyApp::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageSeverityFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT *pCallbackData, void *pUserData)
    {
        std::cerr << "Validation Layer: " << pCallbackData->pMessage << std::endl;
        return VK_FALSE;
    }
    void KnobyApp::frameBufferResizedCallback(GLFWwindow *window, int width, int height)
    {
        auto app = reinterpret_cast<KnobyApp *>(glfwGetWindowUserPointer(window));
        app->frameBufferResized = true;
    }
    std::vector<char> KnobyApp::readFile(const std::string &filename)
    {
...
#pragma region Dynamic Funktions
    bool KnobyApp::checkDeviceExtensionSupport(VkPhysicalDevice device)
    {
    ...
    bool KnobyApp::checkValidationLayerSupport()
    {
        uint32_t layerCount;
    ...
    VkPresentModeKHR KnobyApp::choosePresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes)
    {
    ...
    VkExtent2D KnobyApp::chooseSwapExtend(const VkSurfaceCapabilitiesKHR &capabilities)
    {
    ...
    VkSurfaceFormatKHR KnobyApp::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats)
    {
    ...
    void KnobyApp::cleanUp()
    {
        ...
        vkDestroyDescriptorSetLayout(logicalDevice, descriptionSetLayout, nullptr);
    ...
    void KnobyApp::cleanupSwapChain()
    {
    ...
    void KnobyApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size){
    ...
    void KnobyApp::createCommandBuffers()
    {
    ...
    void KnobyApp::createCommandPools()
    {
    ...
    void KnobyApp::createDescriptorSetLayout(){
        ...
        if(vkCreateDescriptorSetLayout(logicalDevice, &layoutInfo, nullptr, &descriptionSetLayout) != VK_SUCCESS){
            throw std::runtime_error("failed to create descriptor set layout!");
        }

    }
    void KnobyApp::createFramebuffers()
    {
    ...
    void KnobyApp::createGraphicsPipeline()
    {
    ...
    void KnobyApp::createIndexBuffer(){
    ...
    void KnobyApp::createImageViews()
    {
    ...
    void KnobyApp::createRenderPass()
    {
    ...
    void KnobyApp::createLogicalDevice()
    {
    ...
    VkShaderModule KnobyApp::createShaderModule(const std::vector<char> &code)
    {
    ...
    void KnobyApp::createSyncObjects()
    {
    ...
    void KnobyApp::createUniformBuffers(){
    ...
    void KnobyApp::createVertexBuffer(){
    ...
    void KnobyApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags propertyFlags, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
    {
    ...
    uint32_t KnobyApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
    {
    ...
    QueueFamilyIndices KnobyApp::findQueueFamilies(VkPhysicalDevice device)
    {
    ...
    std::vector<const char *> KnobyApp::getRequiredExtensions()
    {
    ...
    bool KnobyApp::isDeviceSuitable(VkPhysicalDevice device)
    {
        /*
    ...
    void KnobyApp::pickPhysicalDevice()
    {
    ...
    void KnobyApp::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo)
    {
        createInfo = {};
    ...
    SwapChainSupportDetails KnobyApp::querySwapChainSupport(VkPhysicalDevice device)
    {
    ...
    void KnobyApp::recordCommandBuffer(VkCommandBuffer cmdBuffer, uint32_t imageIndex)
    {
        VkCommandBufferBeginInfo beginInfo{};
        ...
        vkCmdDrawIndexed(cmdBuffer, static_cast<uint32_t>(indicies.size()),1,0,0,0);
    ...
    void KnobyApp::recreateSwapChain()
    {
    ...
    void KnobyApp::updateUniformBuffer(uint32_t currentImage){
        ...
        ubo.proj = glm::lookAt(glm::vec3(2.0f,2.0f,2.0f), glm::vec3(0.0f,0.0f,0.0f), glm::vec3(0.0f,0.0f,1.0f));
        ubo.view = glm::perspective(glm::radians(45.0f), swapChainExtend.width / (float) swapChainExtend.height, 0.1f, 10.0f);
        ...
        */
        ...
        void* data;
        vkMapMemory(logicalDevice, uniformBufferMemory[currentImage], 0, sizeof(ubo), 0, &data);
        memcpy(data, &ubo, sizeof(ubo));
        vkUnmapMemory(logicalDevice, uniformBufferMemory[currentImage]);
    }
    void KnobyApp::setupDebugMessenger()
    {
        if (!enableValidationLayers)
        {
            return;
